...
.form-dropdown {
  button {
    @apply min-w-[8rem] justify-between inline-block rounded border border-solid border-gray-300 px-2 py-2 leading-tight;
    @apply flex items-center whitespace-nowrap;
  }

  ul {
    @apply absolute z-10 mt-2 min-w-[8rem] rounded bg-gray-50 ring-1 ring-gray-300;
